...
"[project]/app/(auth)/recover/page.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function page() {
    ...
    const handleSubmit = async (event)=>{
        ...
        setLoading(true);
        try {
            await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$actions$2f$userAuthAction$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["userForgotPassword"])(data));
        } finally{
            setLoading(false);
        }
    };
...
//# sourceMappingURL=_afb67db6._.js.map