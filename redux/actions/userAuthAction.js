...
import { AUTHENTICATION_ERROR, GET_USER, LOGIN_USER, REGISTER_USER, AUTH_USER_ERROR, RESET_PASSWORD, FORGOT_PASSWORD } from "./types"
...
try {
    ...
    dispatch({type: FORGOT_PASSWORD, payload: mssg})
