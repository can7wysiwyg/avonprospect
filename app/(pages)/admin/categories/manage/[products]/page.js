'use client'
import { getBrands, getCategory, getProductByCat } from '@/helpers/core/CoreFuncs'
...
export default function Page() {
  ...
  React.useEffect(() => {
    const fetchData = async () => {
      try {
        const prodsInCat = await getProductByCat(products)
        const catSingle = await getCategory(products)
  ...
  React.useEffect(() => {
    ...
    setCurrentPage(1) 
  }, [searchTerm, selectedBrand, sortBy, priceRange, inStockOnly, productsInCategory])
  ...
  return (
    <div className="container py-5">
      {/* Header */}
      <div className="mb-4">
        <h1 className="display-5 fw-bold">{category.catName || "Products"}</h1>
          ...
          <div className="col-md-6">
            <div className="mb-3">
              ...
              <p className="text-muted small">
                Brand: {brands.find(b => b._id === product.brand)?.brandName || 'Unknown'}
              </p>
            </div>
            <hr />
            <div className="mb-3">
